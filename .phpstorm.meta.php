...
'debugbar.queries.explain','entries.index','entries.show',
'entries.update','entries.favorite','entries.ignore','login',
'logout','register','password.request','password.email',
'password.reset','password.update','password.confirm','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','entries.index','entries.show','index','layouts.app',
